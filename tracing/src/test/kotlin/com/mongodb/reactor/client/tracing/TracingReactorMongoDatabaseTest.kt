...
internal class TracingReactorMongoDatabaseTest {
    ...
    @Test
    fun `tracing reactor database should always delegate method calls to the underlying database`() {
        ...
        reactor.getCollection(MongoContainer.COLLECTION_NAME)
        reactor.getCollection(MongoContainer.COLLECTION_NAME, Document::class.java)
        ...
        reactor.createCollection(MongoContainer.COLLECTION_NAME)
        val collectionOptions = CreateCollectionOptions()
        reactor.createCollection(MongoContainer.COLLECTION_NAME, collectionOptions)
        reactor.createCollection(session, MongoContainer.COLLECTION_NAME)
        reactor.createCollection(session, MongoContainer.COLLECTION_NAME, collectionOptions)
        ...
        verifyAll {
            ...
            original.getCollection(MongoContainer.COLLECTION_NAME)
            original.getCollection(MongoContainer.COLLECTION_NAME, Document::class.java)
            ...
            original.createCollection(MongoContainer.COLLECTION_NAME)
            original.createCollection(MongoContainer.COLLECTION_NAME, collectionOptions)
            original.createCollection(session, MongoContainer.COLLECTION_NAME)
            original.createCollection(session, MongoContainer.COLLECTION_NAME, collectionOptions)
    ...
    @Test
    fun `tracing reactor database should emit items`() {
        database
            .listCollectionNames()
            .test()
            .expectSubscription()
