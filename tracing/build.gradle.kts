...
val mongoDriverVersion = "4.2.0"
val reactorVersion = "2020.0.4"
val braveVersion = "5.13.7"
...
dependencies {
    api(project(":mongo-reactor-adapter"))
    ...
    publications {
        create<MavenPublication>("mavenJava") {
            ...
            pom {
                ...
                description.set("OpenTracing aware MongoDB's Reactor adapter for ReactiveStreams driver")
